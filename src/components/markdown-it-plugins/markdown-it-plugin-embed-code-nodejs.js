 ...
 *  // please look at ./relative/file/to/your/code.cpp
 * ```
 * @module mditPluginEmbedCodeNodejs
 * @param {MarkdownItTokens} tokens - MarkdownIt instance
 * @param {MarkdownItOptions} options - options Object
 * @param {Object} env - environment options Object
 ...
 * @version 1.0.0
 * @license MIT
 * @exports mditPluginEmbedCodeNodejs
 */
export function mditPluginEmbedCodeNodejs(md) {
    const defaultRender =
    ...
    md.renderer.rules.fence = function (tokens, idx, options, env, self) {
        embedCode(tokens, idx, options, env);
        return defaultRender(tokens, idx, options, env, self);
    };
}

export default mditPluginEmbedCodeNodejs;
