...
const assetsURL = function(dep) {
  return "/quasar-unplugin-vue-markdown-tests/" + dep;
};
const seen$2 = {};
...
const tokenizer = new Tokenizer(stack, {
  ...
  ondirmodifier(start2, end) {
    ...
    if (inVPre) {
      ...
      const exp = createSimpleExpression(mod, true, getLoc(start2, end));
...
const createRouter = route(function() {
  ...
  const Router = createRouter$1({
    ...
    history: createHistory("/quasar-unplugin-vue-markdown-tests/")
  });
  return Router;
});
...
const quasarUserOptions = { config: { "notify": {}, "dark": "auto" }, plugins: { AddressbarColor, AppFullscreen: Plugin$2, LocalStorage: Plugin$1, SessionStorage: Plugin, Notify } };
const publicPath = `/quasar-unplugin-vue-markdown-tests/`;
...
export {
  ...
  emptyRenderFn as a8,
  layoutKey as a9,
  pageContainerKey as aa,
  useRouterLinkProps as ab,
  useRouterLink as ac,
  hUniqueSlot as ad,
  History as ae,
  getEventPath as af,
  createDirective as ag,
  preventDraggable as ah,
  noop$1 as ai,
  position as aj,
  stop as ak,
  leftClick as al,
  withDirectives as am,
  hDir as an,
  provide as ao,
  isRuntimeSsrPreHydration as ap,
  reactive as aq,
  hMergeSlot as ar,
  childrenCommon as as,
  QIcon as at,
  QBtn as au,
  Platform as av,
  vmHasRouter as aw,
